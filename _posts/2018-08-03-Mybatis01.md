...
> 也可以使用Java配置方式。
>  - 1.此时需要声明UserMapper.java接口，但该接口可以无任何方法
>  - 2.UserMapper.xml需与该接口在同一包下
>  - 3.映射文件的namespace需是com.mybatis.dao.UserMapper（接口全路径）
...
hikariDataSource.setJdbcUrl("jdbc:mysql://localhost:3306/test?useSSL=true");
