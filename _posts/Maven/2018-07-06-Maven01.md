...
> 导入项目后，需要检查下该项目的Maven配置，是否使用了指定的本地仓库
...
> - eclipse4.0+中，preferences中有maven选项，不需要安装maven插件。但较低版本的eclipse需要安装m2e插件，注意插件与eclipse版本要对应
...
以下为Maven标准工程目录，Maven Web工程额外多了webapp目录
