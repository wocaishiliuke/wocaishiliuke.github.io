...
> 可以ssh远程访问，即安装了SSH Server。Ubuntu默认安装了OpenSSH client，但没有默认安装SSH Server）。[安装可参考](https://www.jianshu.com/p/e666af148952)
...
> 为了方便调试，且测试服务器基本都是内网，所以关闭应用服务器的防火墙。可参考[Ubuntu防火墙](https://www.jianshu.com/p/e666af148952)
